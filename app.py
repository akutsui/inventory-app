...
COLUMNS_DEF = {
    ...
    "iPad": [
        "購入日", "ラベル", "AppleID", "AppleIDパスワード", "シリアルNo", # パスワード追加
        "ストレージ", "製造番号IMEI", "端末番号", 
        "使用部署", "キャリア", "備考"
    ],
    "携帯電話": [
    ...
    with st.form("edit_dialog_form"):
        ...
        if cat == "PC":
            ...
            with c1:
                ...
                custom_values['AppleIDパスワード'] = st.text_input("AppleIDパスワード", value=row_data.get('AppleIDパスワード')) # Added
            ...
            with st.form("new_entry_form"):
                ...
                if selected_category_key == "PC":
                    ...
                    with c1:
                        ...
                        custom_values['AppleIDパスワード'] = st.text_input("AppleIDパスワード") # Added
